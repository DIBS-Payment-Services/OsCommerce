...
class dibs extends dibs_api {
    ...
    function dibs() {
        ...
        $this->signature = 'dibs|dibs|4.0.0|2.2';
    ...
    function install() {
        ...
        $this->installApply('Account:', 'MODULE_PAYMENT_DIBS_ACCOUNT', 
                            '', 'If multiple departments utilize the company’s 
                            acquirer agreement with the acquirer. 
                            An ”account number” may be inserted in this field, 
